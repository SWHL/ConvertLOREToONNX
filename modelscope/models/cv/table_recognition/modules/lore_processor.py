...
class Stacker(nn.Module):
    ...
    def __init__(
        self, input_size, hidden_size, output_size, layers, heads=8, dropout=0.1
    ):
        """
        Args:
        ...
        self.tsfm = Transformer(
            2 * hidden_size, hidden_size, output_size, layers, heads, dropout
        )
...
class LoreProcessModel(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.stacker = Stacker(
            self.output_size, self.hidden_size, self.output_size, self.stacking_layers
        )
        self.tsfm_axis = Transformer(
            self.input_size,
            self.hidden_size,
            self.output_size,
            self.tsfm_layers,
    ...
    def forward(self, outputs, dets=None):
        """
        Args:
